...
/**
 * A classe {@code QuickSortVenue} realiza a ordenação de dados em arquivos CSV
 * usando o algoritmo de ordenação Quick Sort.
...
public class QuickSortVenue {
    ...
    /**
     * Cria uma nova instância de {@code QuickSortVenue} com o arquivo de entrada
     * especificado.
     *
    ...
    /**
     * Implementa o algoritmo Quick Sort para ordenar um array bidimensional de
     * strings.
     *
     ...
     *
     * @param data O array em que as linhas serão trocadas.
