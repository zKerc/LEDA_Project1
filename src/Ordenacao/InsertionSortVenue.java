...
public class InsertionSortVenue {
    public static void main(String[] args) {
        ...
        String path = "src/OrdenacaoResultados/InsertionSort/";
        
        String outputMedio = path + "matches_t2_venues_insertionSort_medioCaso.csv";
        String outputMelhor = path + "matches_t2_venues_insertionSort_melhorCaso.csv";
        String outputPior = path + "matches_t2_venues_insertionSort_piorCaso.csv";
    ...
    public static void ordenar(String inputFile, String outputFile, boolean inverter) {
        try (BufferedReader br = new BufferedReader(new FileReader(inputFile));
            ...
            for (int i = 1; i < rowCount; i++) {
                ...
                // Tratar corretamente campos 'venue' vazios
                while (j >= 0 && 
